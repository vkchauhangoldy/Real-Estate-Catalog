...
const UserPropertyPage = () => {
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `https://real-estate-backend-fhhg.onrender.com/api/property/${userId}`,
          {
            method: "GET",
            headers: {
              Authorization: token,
  ...
  const searchHandler = (event) => {
    ...
    const token = getAuthToken();
    fetch(
      `https://real-estate-backend-fhhg.onrender.com/api/property/search/${searchValue}`,
      {
        method: "GET",
        headers: {
          Authorization: token,
  ...
  const deleteHandler = (PPD_ID) => {
    const token = getAuthToken();
    fetch(
      `https://real-estate-backend-fhhg.onrender.com/api/property/delete/${PPD_ID}`,
      {
        method: "DELETE",
        headers: {
  ...
  const editPropertyHandler = (PPD_ID) => {
    const token = getAuthToken();
    fetch(
      `https://real-estate-backend-fhhg.onrender.com/api/property/search/${PPD_ID}`,
      {
        method: "GET",
        headers: {
          Authorization: token,
